...
public class PokemonBank {
	...
	public void handleClient() throws IOException, ClassNotFoundException {
		...
		System.out.println("Un dresseur s'est connecté à la Banque Pokémon.");
		...
		while (running) {
			...
			case LIST:
				...
				if (this.pokemons.size() == 0) {
					 ...
					 */
					oos.writeObject("Il n'y a pas de Pokémons dans la banque !");
				} else {
					/*
					 * TODO
			...
			case STORE:
				...
				System.out.println(pokemon + " reçu.");
				/*
				 * TODO
				 * Then, send a message to the client so he knows his Pokémon is safe.
				 */
				oos.writeObject(pokemon + " a bien été réceptionné !");
				break;
